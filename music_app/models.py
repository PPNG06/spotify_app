...
class Music(models.Model):
    ...
    ENERGY = ((0.3,'Turn Up'),(0.5,'Chill'),(0.8,'Study'))
    artist = models.ForeignKey(Artist,on_delete=models.CASCADE)
    style = models.CharField(max_length=100,choices = STYLE_CHOICES)
    mood = models.FloatField(max_length=1000,choices = ENERGY)
    title = models.CharField(max_length=1000,default='')
    link = models.CharField(max_length=1000,default = '')

    def __str__(self):
        return self.title+', by '+self.artist.__str__()+' (style: '+self.style+', mood: '+str(self.mood)+')'
